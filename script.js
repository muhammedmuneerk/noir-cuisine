...
// Menu Filter
const menuItems = [
    { name: 'Dish 1', category: 'starters', price: '$10' , image:"./images/dish-1.jpeg" , alt:"dish 1 of Noir Cuisine" },
    { name: 'Dish 2', category: 'mains', price: '$20', image:"./images/dish-2.jpg" , alt:"dish 1 of Noir Cuisine " },
    { name: 'Dish 3', category: 'desserts', price: '$8' , image:"./images/dish-3.jpeg" , alt:"dish 1 of Noir Cuisine " },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Masonry layout (optional, requires masonry-layout library)
    // Uncomment the following lines if you want to use Masonry layout
...
function initMap() {
    const restaurantLocation = { lat: 40.7128, lng: -74.0060 }; // Replace with actual coordinates
...
// Blog Posts
const blogPosts = [
    { title: 'The Art of Plating in the Dark', excerpt: 'Discover how our chefs create visually stunning dishes...' },
    { title: 'Wine Pairing: A Sensory Experience', excerpt: 'Learn about our unique approach to wine pairing...' },
    // Add more blog posts
];
...
// This completes the JavaScript file with advanced features and optimizations for the restaurant website.